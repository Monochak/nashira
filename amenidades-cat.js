...
window.FORMA_AMENIDADES = [
  ...
  /* ── Genéricos ────────────────────────────────────────────────────────────
     Los quince de arriba nacieron con Nashira y son suyos de nombre. Estos son
     de cualquiera: cubren lo que un desarrollo pide sin que el estudio tenga
     que dibujar. Un proyecto los usa poniéndoles el nombre que quiera. */
  { key: "alberca", label: "Alberca",
    ic: "<path d=\"M8.5 14.5V6a2.5 2.5 0 0 1 5 0v8.5\"/><path d=\"M8.5 9h5M8.5 11.8h5\"/><path d=\"M2.5 17.2c1.4 0 1.4-1 2.9-1s1.4 1 2.9 1 1.4-1 2.85-1 1.4 1 2.85 1 1.4-1 2.9-1 1.4 1 2.9 1\"/><path d=\"M2.5 20.8c1.4 0 1.4-1 2.9-1s1.4 1 2.9 1 1.4-1 2.85-1 1.4 1 2.85 1 1.4-1 2.9-1 1.4 1 2.9 1\"/>" },
  { key: "jacuzzi", label: "Jacuzzi",
    ic: "<path d=\"M3 12.5h18V16a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4z\"/><path d=\"M6.5 12.5V7a1.8 1.8 0 0 1 3.4-.8\"/><circle cx=\"13.2\" cy=\"7.2\" r=\".7\"/><circle cx=\"16.2\" cy=\"5.4\" r=\".7\"/><circle cx=\"19\" cy=\"7.6\" r=\".7\"/>" },
  { key: "sauna", label: "Sauna y vapor",
    ic: "<path d=\"M4 20.5h16\"/><path d=\"M6.5 20.5V16h11v4.5\"/><path d=\"M9.6 13c0-1.4 1.4-1.4 1.4-2.8s-1.4-1.4-1.4-2.8\"/><path d=\"M13.6 13c0-1.4 1.4-1.4 1.4-2.8s-1.4-1.4-1.4-2.8\"/>" },
  { key: "cine", label: "Sala de cine",
    ic: "<rect x=\"2.5\" y=\"4.5\" width=\"19\" height=\"11.5\" rx=\"1.5\"/><path d=\"M10.3 8.4l4.2 2.4-4.2 2.4z\"/><path d=\"M12 16v4M8 20h8\"/>" },
  { key: "eventos", label: "Salón de eventos",
    ic: "<path d=\"M4.6 3.5h5.6l-.9 4.7a1.9 1.9 0 0 1-3.8 0z\"/><path d=\"M7.4 10.2V20M5.2 20h4.4\"/><path d=\"M13.8 3.5h5.6l-.9 4.7a1.9 1.9 0 0 1-3.8 0z\"/><path d=\"M16.6 10.2V20M14.4 20h4.4\"/>" },
  { key: "juntas", label: "Sala de juntas",
    ic: "<rect x=\"6\" y=\"8.6\" width=\"12\" height=\"6.8\" rx=\"3.4\"/><circle cx=\"3.6\" cy=\"12\" r=\"1.3\"/><circle cx=\"20.4\" cy=\"12\" r=\"1.3\"/><circle cx=\"9.6\" cy=\"5.4\" r=\"1.3\"/><circle cx=\"14.4\" cy=\"5.4\" r=\"1.3\"/><circle cx=\"9.6\" cy=\"18.6\" r=\"1.3\"/><circle cx=\"14.4\" cy=\"18.6\" r=\"1.3\"/>" },
  { key: "ludoteca", label: "Área infantil",
    ic: "<path d=\"M2.8 16.6l18.4-5.2\"/><path d=\"M12 13.9l-2.6 6.6h5.2z\"/><circle cx=\"4.6\" cy=\"16\" r=\"1.5\"/><circle cx=\"19.4\" cy=\"11.8\" r=\"1.5\"/>" },
  { key: "cancha", label: "Cancha deportiva",
    ic: "<rect x=\"3\" y=\"5\" width=\"18\" height=\"14\" rx=\"1.5\"/><path d=\"M12 5v14\"/><circle cx=\"12\" cy=\"12\" r=\"2.6\"/><path d=\"M3 9h2.6v6H3M21 9h-2.6v6H21\"/>" },
  /* Flor de loto y no una figura: a 24 px una persona se vuelve una mancha. */
  { key: "yoga", label: "Yoga y pilates",
    ic: "<path d=\"M12 20c-2.4-1.8-3.8-4.5-3.8-7.5 0-2.4 1.4-4.7 3.8-6.3 2.4 1.6 3.8 3.9 3.8 6.3 0 3-1.4 5.7-3.8 7.5z\"/><path d=\"M12 20c-3.4.1-6.6-1.7-8.2-4.7 1.5-1.3 3.4-2 5.4-1.9\"/><path d=\"M12 20c3.4.1 6.6-1.7 8.2-4.7-1.5-1.3-3.4-2-5.4-1.9\"/>" },
  { key: "cava", label: "Cava",
    ic: "<path d=\"M10 3h4v4l1.4 2.1a3 3 0 0 1 .6 1.8V20a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1v-9.1a3 3 0 0 1 .6-1.8L10 7z\"/><path d=\"M8 13.5h8\"/>" },
  { key: "lavanderia", label: "Lavandería",
    ic: "<rect x=\"4\" y=\"3\" width=\"16\" height=\"18\" rx=\"2\"/><path d=\"M4 9.2h16\"/><circle cx=\"12\" cy=\"15\" r=\"3.8\"/><circle cx=\"7.4\" cy=\"6.1\" r=\".7\"/><circle cx=\"10.4\" cy=\"6.1\" r=\".7\"/>" },
  { key: "bicicletas", label: "Bicicletero",
    ic: "<circle cx=\"5.6\" cy=\"17\" r=\"3.2\"/><circle cx=\"18.4\" cy=\"17\" r=\"3.2\"/><path d=\"M5.6 17l4-8h4.6\"/><path d=\"M9.6 9l4.6 8\"/><path d=\"M13.4 9h3.4\"/>" },
  { key: "estacionamiento", label: "Estacionamiento",
    ic: "<rect x=\"3.5\" y=\"3.5\" width=\"17\" height=\"17\" rx=\"3\"/><path d=\"M9.6 16.6V7.4h3.2a2.9 2.9 0 0 1 0 5.8H9.6\"/>" },
  { key: "recepcion", label: "Recepción",
    ic: "<path d=\"M3.5 17.6h17\"/><path d=\"M5.2 17.6a6.8 6.8 0 0 1 13.6 0\"/><path d=\"M12 10.8V8.4\"/><circle cx=\"12\" cy=\"6.9\" r=\"1.3\"/>" },
  { key: "solar", label: "Paneles solares",
    ic: "<path d=\"M4 17.4h14l-2.2-9H6.2z\"/><path d=\"M7 12.9h10\"/><path d=\"M11.6 8.4l-1.2 9\"/><path d=\"M12 4.2V2.2M17.3 5.7l1.3-1.3M6.7 5.7L5.4 4.4\"/>" },
  { key: "agua", label: "Tratamiento de agua",
    ic: "<path d=\"M12 3.4s5.6 6.1 5.6 9.6a5.6 5.6 0 0 1-11.2 0C6.4 9.5 12 3.4 12 3.4z\"/><path d=\"M9.3 13.4c0 1.7 1.2 3 2.7 3\"/>" },
  { key: "wifi", label: "Internet",
    ic: "<path d=\"M3.4 9.4a13 13 0 0 1 17.2 0\"/><path d=\"M6.5 13a9 9 0 0 1 11 0\"/><path d=\"M9.6 16.5a5 5 0 0 1 4.8 0\"/><circle cx=\"12\" cy=\"19.6\" r=\"1\"/>" },
];
